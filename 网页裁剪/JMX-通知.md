...
[标准 MBeans](https://docs.oracle.com/javase/tutorial/jmx/mbeans/standard.html) 中的 [`Hello`](https://docs.oracle.com/javase/tutorial/jmx/examples/Hello.java) MBean 实现实际上实现了通知机制。但是，为简单起见，该课中省略了此代码。`Hello` 的完整代码如下：
