...
分类:
  - "网页裁剪"
标题: "Guarded Blocks (The Java™ Tutorials >        
...
[[并发-starvelive|« Previous]] • [Trail](https://docs.oracle.com/javase/tutorial/essential/TOC.html) • [[并发-immutable|Next »]]
...
**Note:** The `Drop` class was written in order to demonstrate guarded blocks. To avoid re-inventing the wheel, examine the existing data structures in the [[集合|Java Collections Framework]] before trying to code your own data-sharing objects. For more information, refer to the [[并发-questions|Questions and Exercises]] section.
