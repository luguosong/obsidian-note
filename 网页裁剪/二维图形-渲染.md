...
---
# Java 2D Rendering (The Java™ Tutorials >        
            2D Graphics > Overview of the Java 2D API Concepts)
...
| ![[--2D-10.gif]] | *Rendering hints* specify preferences in the trade-offs between speed and quality. For example, you can specify whether antialiasing should be used, if this feature available. See also [[二维图形-quality|Controlling Rendering Quality]]. |
