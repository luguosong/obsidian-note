...
- [Referenceable objects and JNDI Reference s](https://docs.oracle.com/javase/jndi/tutorial/objects/storing/reference.html)  
	The bind() examples in the [Add, Replace or Remove a Binding](https://docs.oracle.com/javase/tutorial/jndi/ops/bind.html) lesson use Referenceable objects.
