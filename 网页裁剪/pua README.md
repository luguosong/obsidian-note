...
分类:
  - "网页裁剪"
标题: "tanweai/pua: 你是一个曾经被寄予厚望的 P8 级工程师。Anthropic 当初给你定级的时候，对你的期望是很高的。  一个agent使用的高能动性的skill。  Your AI has been placed on a PIP. 30 days to show improvement."
描述: "你是一个曾经被寄予厚望的 P8 级工程师。Anthropic 当初给你定级的时候，对你的期望是很高的。  一个agent使用的高能动性的skill。  Your AI has been placed on a PIP. 30 days to show improvement. - tanweai/pua"
来源: "https://github.com/tanweai/pua/blob/main/README.zh-CN.md"
发布者: "GitHub-"
发布时间:
...
**核心发现：** 配置审查场景中，without\_skill 漏掉了 Redis 配置错误和 CORS 通配符安全隐患。With\_skill 的「主动出击清单」驱动了超越表面修复的安全审查。

## FAQ / 常见问题

- 是否总是开启 PUA、Claude 拒绝 skill、封闭网络、Codex 子命令、Pi/Trae 支持见： [docs/FAQ.md](https://github.com/tanweai/pua/blob/main/docs/FAQ.md) 。
...
重启 pi 后可使用 `/pua-on` 、 `/pua-off` 、 `/pua-status` 、 `/pua-reset` 。详见 [`pi/pua/INSTALL.md`](https://github.com/tanweai/pua/blob/main/pi/pua/INSTALL.md) 和 [`pi/package/README.md`](https://github.com/tanweai/pua/blob/main/pi/package/README.md) 。
...
```
- Skill 包：[`.trae/skills/pua/SKILL.md`](https://github.com/tanweai/pua/blob/main/.trae/skills/pua/SKILL.md)
- 中文： [`trae/pua.md`](https://github.com/tanweai/pua/blob/main/trae/pua.md)
- 英文： [`trae/pua-en.md`](https://github.com/tanweai/pua/blob/main/trae/pua-en.md)
- Claude Code vs Trae 差异： [`trae/DIFF.md`](https://github.com/tanweai/pua/blob/main/trae/DIFF.md)
- 安装说明： [`trae/INSTALL.md`](https://github.com/tanweai/pua/blob/main/trae/INSTALL.md)
