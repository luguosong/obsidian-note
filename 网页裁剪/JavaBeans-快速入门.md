...
分类:
  - "网页裁剪"
标题: "JavaBeans 快速入门"
描述: "《Java 教程》JavaBeans 路线课程，描述如何使用 NetBeans 构建简单应用程序，将 JavaBeans 组件组装成应用程序而无需编写代码。"
来源: "https://docs.oracle.com/javase/tutorial/javabeans/quick/index.html"
发布者: "Oracle-"
发布时间:
...
本课描述如何使用 NetBeans 构建一个简单的应用程序。借助像 NetBeans 这样的优秀工具，你可以将 JavaBeans 组件组装成应用程序而无需编写任何代码。
