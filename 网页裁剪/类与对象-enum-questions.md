...
分类:
  - "网页裁剪"
标题: "Questions and Exercises: Enum Types (The Java™ Tutorials >        
...
---
# Questions and Exercises: Enum Types (The Java™ Tutorials >        
            Learning the Java Language > Classes and Objects)
...
[[类与对象-enum|« Previous]] • [Trail](https://docs.oracle.com/javase/tutorial/java/TOC.html) • [[学习Java语言-注解|Next »]]
...
1. Rewrite the class `Card` from the exercise in [[类与对象-创建类练习|Questions and Exercises: Classes]] so that it represents the rank and suit of a card with enum types.
2. Rewrite the `Deck` class.

[[类与对象-enum-answers|Check your answers.]]