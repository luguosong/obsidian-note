...
[« Previous](https://docs.oracle.com/javase/tutorial/extra/generics/legacy.html) • [Trail](https://docs.oracle.com/javase/tutorial/extra/TOC.html) • [Next »](https://docs.oracle.com/javase/tutorial/extra/generics/literals.html)
...
The way to work around these kinds of limitations is to use class literals as run time type tokens, as described in the next section, [Class Literals as Runtime-Type Tokens](https://docs.oracle.com/javase/tutorial/extra/generics/literals.html).