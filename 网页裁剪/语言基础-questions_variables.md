...
分类:
  - "网页裁剪"
标题: "Questions and Exercises: Variables (The Java™ Tutorials >        
...
[[语言基础-variablesummary|« Previous]] • [Trail](https://docs.oracle.com/javase/tutorial/java/TOC.html) • [[语言基础-operators|Next »]]
...
1. The term "instance variable" is another name for \_\_\_.
2. The term "class variable" is another name for \_\_\_.
3. A local variable stores temporary state; it is declared inside a \_\_\_.
...
6. Character strings are represented by the class \_\_\_.
7. An \_\_\_ is a container object that holds a fixed number of values of a single type.
...
[[语言基础-answers_variables|Check your answers]]