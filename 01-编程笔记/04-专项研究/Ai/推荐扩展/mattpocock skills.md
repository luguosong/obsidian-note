...
| skill    | 描述                                                                                      |
| -------- | --------------------------------------------------------------------------------------- |
| ask-matt | 询问哪个 Skills(技能)或流程适合你的情况。这是该仓库中用户调用 Skills(技能)的路由器。<br><br>注意：只局限于 mattpocock 包含的 skill |
...
| skill           | 描述                                   |
| --------------- | ------------------------------------ |
| tdd             | 鼓励红绿重构，并为 agent 提供大量关于什么是好的和坏的测试的指导。 |
| diagnosing-bugs | 将最佳调试实践包装成一个简单的循环                    |
