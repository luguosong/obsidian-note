...
```bash
node ".Codex/skills/defuddle/scripts/detect-code-languages.js" "网页裁剪/<文件名>.md"
```
...
```bash
node ".Codex/skills/defuddle/scripts/download-images.js" "网页裁剪/<文件名>.md" --prefix "<可选前缀>"
```
...
```bash
# 预览改名映射（不实际改动）
node .Codex/skills/defuddle/scripts/rename-to-hash.js --dry-run

# 确认后实跑
node .Codex/skills/defuddle/scripts/rename-to-hash.js
```
...
```bash
node ".Codex/skills/defuddle/scripts/detect-code-languages.js" "网页裁剪/Context7 README.md"
node ".Codex/skills/defuddle/scripts/download-images.js" "网页裁剪/Context7 README.md" --prefix "context7-"
```
